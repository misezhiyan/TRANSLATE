package com.translate.po.funcenum;
...
public enum Punctuation {
	...
	// 中文区
	DOU_CHINESE("，", "CHINESE", false, null, true, 1, false), JU_CHINESE("。", "CHINESE", false, null, true, 2, true), WEN_CHINESE("？", "CHINESE", false, null, true, 3, true), TAN_CHINESE("！", "CHINESE", false, null, true, 4, true), DUN_CHINESE("、", "CHINESE", false, null, false, null, false), ZHONGHENGXIAN_CHINESE("–", "CHINESE", false, null, false, null, false), DAKUOHAO_CHINESE("{", "CHINESE", true, "}", true, 5, false), ZHONGKUOHAO_CHINESE("【", "CHINESE", true, "】", true, 6, false), XIAOKUOHAO_CHINESE("（", "CHINESE", true, "）", true, 7, false), JIANKUOHAO_CHINESE("《", "CHINESE", true, "》", true, 8, false), YINHAO_DAN_CHINESE("‘", "CHINESE", true, "’", true, 9, false), YINHAO_SHUANG_CHINESE("“", "CHINESE", true, "”", true, 10, false),
	// 英文区
	DOU_ENGLISH(",", "ENGLISH", false, null, true, 1, false), JU_ENGLISH(".", "ENGLISH", false, null, true, 2, true), WEN_ENGLISH("?", "ENGLISH", false, null, true, 3, true), TAN_ENGLISH("!", "ENGLISH", false, null, true, 4, true), ZHONGHENGXIAN_ENGLISH("-", "ENGLISH", false, null, false, null, false), DAKUOHAO_ENGLISH("{", "ENGLISH", true, "}", true, 5, false), ZHONGKUOHAO_ENGLISH("[", "ENGLISH", true, "]", true, 6, false), XIAOKUOHAO_ENGLISH("(", "ENGLISH", true, ")", true, 7, false), JIANKUOHAO_ENGLISH("<", "ENGLISH", true, ">", true, 8, false), YINHAO_DAN_ENGLISH("'", "ENGLISH", true, "'", true, 9, false), YINHAO_SHUANG_ENGLISH("\"", "ENGLISH", true, "\"", true, 10, false),;

	// 获取断句标点字符串
	public static List<String> getPunctuationsSentenseSplit_symbol(String language) {
	...
	// 字符串中标点符号转为指定语言标点符号
	public static String exchangePuctuation(String src, String language) {
	...
	// 字符串中标点符号转为指定语言标点符号
	public static List<String> exchangePuctuation(List<String> srcList, String language) {

		List<String> dstList = new ArrayList<String>();
		for (String src : srcList) {
			String dst = exchangePuctuation(src, language);
			dstList.add(dst);
		}
	...
	private Punctuation(String symbol, String language, boolean canClose, String closeFlag, boolean canTranslate, Integer matchNumber, boolean senteseSplit) {
